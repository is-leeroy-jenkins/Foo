...
`loaders.py`, provider classes from `generators.py`, and API/data-source wrappers from
`fetchers.py`.
...
The application initializes Streamlit in wide layout, loads the configured mode map from
`config.py`,
